...
require("./paginas/historia.css");

require("./paginas/musica.css");

require("./paginas/sobremi.css");

var _historia2 = require("./paginas/historia.js");

var _sobremi2 = require("./paginas/sobremi.js");

var _musica2 = require("./paginas/musica.js");

var _VienneseWaltz = _interopRequireDefault(require("./assets/imagenes/VienneseWaltz.jpg"));
...
imagen.src = _VienneseWaltz.default;
...
function historia() {
  (0, _historia2.crearHistoria)();
}

function sobremi() {
  (0, _sobremi2.crearSobreMi)();
}

function musica() {
  (0, _musica2.crearMusica)();
} //**********Polifylls********** */
